...
trap "echo 'Shutting down'; pkill -P $EUREKA_SERVER_PID; pkill -P $GATEWAY_SERVER_PID; pkill -P $AUTH_SERVICE_PID; pkill -P $REPO_SERVICE_PID; pkill -P $CLIENT_PID; exit 0" INT
