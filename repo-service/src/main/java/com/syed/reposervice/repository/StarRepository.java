...
public interface StarRepository extends JpaRepository<StarredRepo, Long> {
    ...
    List<StarredRepo> findAllByRepoIdAndStarredBy(Long repoId, String starredBy);
    /*
    ...
    default void deleteByRepoIdAndStarredBy(Long repoId, String starredBy) {
        List<StarredRepo> starredRepos = findAllByRepoIdAndStarredBy(repoId, starredBy);
